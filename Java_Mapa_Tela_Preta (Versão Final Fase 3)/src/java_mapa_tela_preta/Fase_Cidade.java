 ...
 * @author Flavio
 */
public class Fase_Cidade extends Capital{
    ...
    String regiao,cidade;
       ...
       System.out.println("O jogador tem que selecionar uma Cidade e dizer a qual Regiao ela pertence.");
       ...
       while(controlaLoop < tamanhoLista){
        ...
        System.out.println("Digite a Regiao escolhida:  ");
        regiao = Seta_Texto();
